const About = () => {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-serif text-center mb-8">About RD Saree Collections</h1>
      <div className="prose max-w-none">
        <p className="text-lg mb-6">
          Welcome to RD Saree Collections, your premier destination for exquisite sarees that blend tradition with contemporary style.
        </p>
