        ...
        <div className="space-y-6">
          ...
          <div className="mt-8 space-y-4">
            <button
              ...
              className="group relative w-full bg-[#25D366] hover:bg-[#128C7E] text-white rounded-xl py-4 px-6 transition-all duration-300 shadow-lg hover:shadow-xl overflow-hidden"
            >
            ...
            <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
              <div className="flex items-start gap-3">
                <div className="w-8 h-8 rounded-full bg-[#25D366]/10 flex items-center justify-center flex-shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#25D366]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <p className="text-sm text-gray-600">
                  Click the button above to discuss product details and place your order through WhatsApp. Our team will assist you with the purchase process.
                </p>
              </div>
            </div>
          </div>
